...
|------|------|-------------|--------|
| r0->r1 | 0x40400002 | [0][0] East [0][1] | PASS |
| r0->r2 | 0x80400003 | [0][0] South [1][0] | PASS |
| r0->r3 | 0xC0400004 | [0][0] East [0][1] South [1][1] | PASS |
| r1->r0 | 0x00400005 | [0][1] West [0][0] | PASS |
| r1->r2 | 0x80400007 | [0][1] South [1][1] West [1][0] | PASS |
| r1->r3 | 0xC0400008 | [0][1] South [1][1] | PASS |
| r2->r0 | 0x00400009 | [1][0] North [0][0] | PASS |
| r2->r1 | 0x4040000A | [1][0] East [1][1] North [0][1] | PASS |
| r2->r3 | 0xC040000C | [1][0] East [1][1] | PASS |
| r3->r0 | 0x0040000D | [1][1] North [0][1] West [0][0] | PASS |
| r3->r1 | 0x4040000E | [1][1] North [0][1] | PASS |
| r3->r2 | 0x8040000F | [1][1] West [1][0] | PASS |
...
4. **Blocking = in BFM** - NBA causes awsize/awburst to arrive as 0 at DUT
